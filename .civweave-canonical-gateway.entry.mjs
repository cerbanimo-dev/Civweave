...
const sourcePath = path.join(rootDir, 'releases', '1.0.104', 'server', 'server-gateway-v131-base.mjs');
const runtimePath = path.join(rootDir, '.civweave-gateway-v132.loader.mjs');
const VERSION = '1.0.104-render-installed-runtime-v132';
...
const canonicalInstallOrigin='https://commonweave.pages.dev';
...
source = source.replace("const sourcePath = path.join(rootDir, 'server.mjs');", "const sourcePath = path.join(rootDir, 'releases', '1.0.104', 'server', 'server.mjs');");
