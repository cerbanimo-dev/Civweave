...
The launch-hardening branch is materialized as canonical release **1.0.135**. Generated release, service-worker, and shell-integrity assets are produced by the repository's canonical materializer rather than edited by hand.
