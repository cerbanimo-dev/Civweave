# Civweave Host Node Hub v1.0.7

- Adds a canonical hosted campus seed at `/downloads/civweave-pocket-campus.cwseed`.
- Preserves `/field/civweave/seed` as a compatibility alias.
