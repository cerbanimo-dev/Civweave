# Civweave Capability-to-Room Parity Ledger

> Canonical endpoint: `/app/shared/civweave-parity-ledger.json`
>
> Base capability source: `public/app/shared/civweave-parity-ledger.part1.b64` through `.part4.b64` (lossless gzip-base64)
>
> Cabinet renderer overlay: `public/app/shared/cabinet-shells-v129.json`

Civweave now has one information architecture and two renderers. As of v1.0.30, the Lite renderer is projected through the same five cabinet shells used as in-world terminal assets:
...
|---|---:|---:|---:|---|---|
| Civweave | Weaveling | 6 | 16 | `/loom/` | `/lite/?system=civweave` |
...
1. **Set up a model** in Settings Hall (`civweave.model-setup`)
2. **Tell Weaveling a wish** in Compass Chamber (`civweave.state-wish`)
3. **Clarify the wish** in Compass Chamber (`civweave.clarify-wish`)
4. **Choose skill posture** in Compass Chamber (`civweave.skill-posture`)
5. **Generate the three paths** in Route Board (`civweave.generate-weave`)
6. **Review and revise the weave** in Route Board (`civweave.review-weave`)
7. **Activate the weave** in Route Board (`civweave.activate-weave`)
...
17. **View Acorns and Buttons** in Reward Loom (`civweave.reward-wallet`)
...
- `public/app/shared/civweave-parity-ledger.part1.b64` through `.part4.b64` (served as `/app/shared/civweave-parity-ledger.json`)
- `public/app/shared/civweave-parity-runtime.js`
...
- `Current integrated Civweave`: Civweave-main.zip 1.0.27
- `Service reference bundle`: services(1).zip 
- `GitHub source of truth`: cerbanimo-dev/Civweave main
