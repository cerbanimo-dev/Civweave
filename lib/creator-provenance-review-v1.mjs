...
const REVIEWERS = new Set(['deterministic','model','human','hybrid']);
...
export function buildProvenanceReviewRequest(sample = {}, analysis = {}) {
  ...
  return Object.freeze({
    ...
    requestedLane: ['model','human','hybrid'].includes(sample.reviewLane) ? sample.reviewLane : 'hybrid',
