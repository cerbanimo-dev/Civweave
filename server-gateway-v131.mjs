...
const runtimePath = path.join(rootDir, '.commonweave-gateway-v132.loader.mjs');
const VERSION = '1.0.6-render-installed-runtime-v132';
...
if (!source.includes(before)) {
  throw new Error('Commonweave gateway v132 could not find the legacy installed-runtime boundary.');
}
