...
const sourcePath = path.join(rootDir, 'releases', '1.0.104', 'server', 'server.mjs');
const runtimePath = path.join(rootDir, '.civweave-gateway-v131.runtime.mjs');
const VERSION = '1.0.104';
const BUILD = '1.0.104-install-only-fullscreen-family-gateway';
...
replaceRequired("    releasedAt: STARTED_AT, appUrl: `${root}/app/?setup=1&host=${encodeURIComponent(root)}`,\n    downloadUrl: `${root}/downloads/Civweave-Mobile-Install-Kit.zip`, sha256: installKitSha256,\n    bytes: installKitSize, mandatory: false, notes: 'Current stable Civweave host-node and offline PWA release.'","    releasedAt: STARTED_AT, appUrl: CIVWEAVE_INSTALL_ORIGIN, installUrl: CIVWEAVE_INSTALL_ORIGIN, sourceUrl: CIVWEAVE_SOURCE_URL,\n    downloadUrl: CIVWEAVE_RELEASE_URL, sha256: '', bytes: 0, mandatory: false, localInstallRequired: true,\n    notes: 'The public origin distributes the Civweave v1.0.104 fixed-settings-layer device package.'",'release packet hosting fields');
...
replaceRequired("appUrl: `${requestOrigin(req, url)}/app/`, downloadUrl: `${requestOrigin(req, url)}/downloads/Civweave-Mobile-Install-Kit.zip`, seedUrl: `${requestOrigin(req, url)}/downloads/civweave-pocket-campus.cwseed`, release: releasePacket(requestOrigin(req, url)), tokenRequired: Boolean(HUB_TOKEN), features: ['node-registration','heartbeat','relay-envelopes','presence','sse-events','release-broadcasts','pwa-hosting','offline-installer','gemini-agent-proxy','campus-seed-download']","appUrl: CIVWEAVE_INSTALL_ORIGIN, installUrl: CIVWEAVE_INSTALL_ORIGIN, sourceUrl: CIVWEAVE_SOURCE_URL, downloadUrl: CIVWEAVE_RELEASE_URL, seedUrl: null, release: releasePacket(requestOrigin(req, url)), tokenRequired: Boolean(HUB_TOKEN), features: ['install-only-pwa','device-package-distribution','fullscreen-software-family','node-registration','heartbeat','relay-envelopes','presence','sse-events','release-broadcasts','release-advertising','node-ai-marketplace-v1','federation-finder','node-ai-operator-status'], aiWallet: aiWalletHttp.status()",'public config hosting fields');
