...
const sourcePath = path.join(rootDir, 'releases', '1.0.83', 'server', 'server.mjs');
const runtimePath = path.join(rootDir, '.civweave-gateway-v131.runtime.mjs');
const VERSION = '1.0.83';
const BUILD = '1.0.83-install-only-fullscreen-family-gateway';
