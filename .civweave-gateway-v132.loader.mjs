...
const sourcePath = path.join(rootDir, 'releases', '1.0.132', 'server', 'server.mjs');
const runtimePath = path.join(rootDir, '.civweave-gateway-v131.runtime.mjs');
const VERSION = '1.0.132';
const BUILD = '1.0.132-install-only-fullscreen-family-gateway';
