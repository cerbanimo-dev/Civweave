...
const BUILD_VERSION = '1.0.104-install-only-fullscreen-family-gateway';
...
const CIVWEAVE_INSTALL_ORIGIN = process.env.CIVWEAVE_INSTALL_ORIGIN || 'https://commonweave.pages.dev';
...
function releasePacket(baseUrl = DEFAULT_PUBLIC_HOST) {
  ...
  return {
    ...
    notes: 'The public origin distributes the Civweave v1.0.104 fixed-settings-layer device package.'
  };
}
