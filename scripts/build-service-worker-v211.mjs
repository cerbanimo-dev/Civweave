...
const output=`// GENERATED: direct five-system routes + canonical persistent five-guide rail + Guild/Map actions on every system + no iframe family shell.
...
// staging-installed-entry-takeover-v6-direct-shell: force stale iframe-shell installations onto the direct-page navigation package.
const V203_STAGING_RECOVERY_HOST='civweave-staging.pages.dev';
const V203_STAGING_RECOVERY_CACHE='cwrecovery-v438-direct-shell';
const V203_STAGING_RECOVERY_MARKER='/__civweave/staging-installed-entry-takeover-v6-direct-shell';
