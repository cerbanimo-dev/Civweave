...
console.log(JSON.stringify({ok:true,version,revision:'working-campus-topbar-v243-federation-finder-v268-no-localhost-v1',checks:checks.length,stickyTop:true,chatSafe:true,mapHandshake:['federation-finder-v1.7.2','same-origin-pwa-navigation','explicit-remote-node-fallback','direct-api-fallback','register-fallback','event-fallback','same-origin-route-fallback']},null,2));
