...
check('finder boots from bundled data before optional network refresh',finderRuntime.includes("const BUNDLED='/app/federation-finder-data/federation-seed-v269.json'")&&finderRuntime.indexOf('fetch(BUNDLED')<finderRuntime.indexOf('async function refreshPublic'));
