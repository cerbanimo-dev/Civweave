...
assert.ok(nodeSource.includes('/api/fabric/location'));
assert.ok(nodeSource.includes('normalizeHubLocation'));
assert.ok(nodeSource.includes('civweave.hub-location-owner.v1'));
