...
for(const token of ["VERSION='1.0.6-settings-controller-v181'","appVersion:'1.0.6'","presentation:'self-contained-fixed-layer'",'nativeDialog:false','transformerActive:false','providerRuntimeOnOpen:false','function build()','function open()'])assert(controller.includes(token),`controller missing ${token}`);
