...
includes(runtime,["VIDEO_CACHE_NAME='cw-video-learning-atlas-v1'","VIDEO_MIRROR_CACHE_NAME='cwknowledge-video-learning-atlas-v1'","SUPPLEMENTAL_CACHE_NAME='cwknowledge-school-supplemental-v1'",'stageLearningSourcePacks','learningSourcePackStatus','searchSupplementalArticles','youtube-availability-current','https://en.wikipedia.org/w/api.php',"origin:'*'","crypto.subtle.digest('SHA-256'"],'unified source-pack runtime');
...
includes(recommender,['Recommended learning packs','stageLearningSourcePacks','sourceSchoolSlugs','Articles and matched video links download together.'],'Living School pack recommender');
