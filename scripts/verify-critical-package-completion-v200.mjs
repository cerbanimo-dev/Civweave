...
assert(core.includes("const BUILD = 'lightweight-shell-v208'"),'Retained lightweight worker core changed unexpectedly.');
...
console.log(JSON.stringify({ok:true,repair:'living-school-cleanroom-v218',workerOrder:['living-school-cache-retirement','retained-lightweight-core'],offlineCampusPreserved:true,otherRealmCompatibilityPreserved:true,legacyLivingSchoolCacheEviction:true},null,2));
