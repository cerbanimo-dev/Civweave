...
await import('./verify-installer-campus-progress-v1.mjs');
console.log(JSON.stringify({ok:true,launch:{version:launchVersion,path:`releases/${launchVersion}`,hashes:Object.keys(launch.sha256||{}).length},current:{version,path:`releases/${version}`,hashes:Object.keys(current.sha256||{}).length},compatibilityPointers:0,archiveDirectory:false},null,2));
