...
assert(shell.includes('data-build="persistent-system-shell-v1-r6-canonical-local-settings"'),'Persistent shell must expose the current cache-busted shell build.');
assert(shell.includes('/app/persistent-system-shell-v1.js?v=1.1.2-canonical-local-settings-refresh'),'Persistent shell HTML must request the current shell runtime rather than a stale cached copy.');
