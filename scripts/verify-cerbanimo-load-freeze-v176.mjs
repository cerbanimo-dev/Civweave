...
assert(shell.includes('persistent-system-shell-v1-r6-canonical-local-settings'),'Persistent shell must retain the full-height stage while using the cache-busted local-settings revision.');
