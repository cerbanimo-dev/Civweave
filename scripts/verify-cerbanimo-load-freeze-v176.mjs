...
const realmRuntime=read('public/app/realm-console-v140.js');
...
assert(realmRuntime.includes("dispatchEvent(new CustomEvent('civweave:realm-console-ready'"),'Realm console must emit an explicit ready event after first render.');
assert(questPath.includes("addEventListener('civweave:realm-console-ready'"),'Generated Cerbanimo Quest paths must wait for the console-ready lifecycle.');
...
console.log('Cerbanimo load-freeze regression contract passed: first render wins; Quest paths, packs, and media are lazy; proof decoration converges.');
