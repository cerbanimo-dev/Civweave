...
console.log(JSON.stringify({ok:true,revision:'ai-settings-entry-runtime-spine-v320',settingsClickOwner:'CivweaveSettingsV320',singleSettingsMenu:true,singleRuntimeSpine:true,geminiMiddleware:true,localHandler:true,memoryRuntimeWrapper:false},null,2));
