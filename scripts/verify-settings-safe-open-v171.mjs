...
assert.doesNotMatch(coreRuntime,/data-open-unified-ai-settings|addEventListener[^\n]*\('click'/,'Core runtime may assemble Settings but may not own Settings input.');
...
console.log(JSON.stringify({ok:true,revision:'settings-safe-open-v320-core-interface-runtime-v1',settingsOwner:'CivweaveSettingsV320',interfaceRuntime:'core-interface-runtime-v1',entryPoints:5,oneInputListener:true,onePresentationOwner:true,managementAfterPaint:true,providerRuntimeOnOpen:false,livingSchoolShared:true,campusPreflight:false},null,2));
