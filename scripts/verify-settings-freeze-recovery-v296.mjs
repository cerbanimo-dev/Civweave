...
console.log(JSON.stringify({ok:true,revision:'settings-freeze-recovery-v317',singleSettingsInputOwner:true,firstClickActivation:true,settingsOpenBeforeManagement:true,managementAfterPaint:true,noGlobalObserverPatch:true,inferenceDormantOnSettingsOpen:true,terminalInferenceCancellation:true},null,2));
