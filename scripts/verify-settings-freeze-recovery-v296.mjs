...
const [gateway,controller,lifecycle,runtime,chatRuntime,chatOwner]=await Promise.all(['public/app/settings-gateway-v317.js','public/app/model-settings-controller-v173.js','public/app/document-lifecycle-v221.js','public/app/local-ai/runtime-v266.js','public/app/local-chat-runtime-v295.js','public/app/local-chat-owner-v295.js'].map(read));
