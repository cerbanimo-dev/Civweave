...
check('service worker retains current chat repair and freeze cache-bust while purging mobile hardening assets',workerEntry.includes('chat-avatar-visible-v346')&&workerEntry.includes('freeze=chat-interaction-safe-v348')&&workerRepair.includes("const REVISION='chat-avatar-visible-v346'")&&workerRepair.includes("const FREEZE_REVISION='chat-interaction-safe-v348'")&&workerRepair.includes("const HARDENING_REVISION='mobile-ai-hardening-v302'")&&workerRepair.includes("'/app/mobile-ai-hardening-v302.js'")&&workerRepair.includes("'/app/local-ai/test-pulse-v269.js'"));
