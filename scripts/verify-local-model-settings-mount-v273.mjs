...
console.log(JSON.stringify({ok:true,revision:'local-model-settings-mount-v320',canonicalSettingsMount:true,settingsAuthority:'CivweaveSettingsV320',localModelServiceOnly:true,managementAfterPaint:true,noSettingsCaptureInLifecycle:true,inferenceDormantUntilNeeded:true},null,2));
