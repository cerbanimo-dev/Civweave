...
const checks = [
  ...
  [installBoundary.includes("const LOCALITY_GOSSIP_RUNTIME='/app/civweave-locality-gossip-v1.js'") && installBoundary.indexOf('HOST_NODE_SESSION,\n  LOCALITY_GOSSIP_RUNTIME') >= 0, 'installed Civweave surfaces load locality gossip after Hub session runtime'],
