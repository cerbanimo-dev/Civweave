...
const checks = [
  ...
  [manifest.assets.includes('/app/civweave-hub-map-v1.js') && manifest.assets.includes('/app/civweave-locality-gossip-v1.js'), 'Guild Map and locality gossip are offline package assets'],
  [wrapper.includes('Guild Map') && wrapper.includes('Guilds') && wrapper.includes('civweave-locality-gossip-v1.js') && wrapper.includes('civweave-hub-map-v1.js'), 'Guild Map wrapper relabels the compatibility map and loads Guild behavior'],
