...
const checks = [
  ...
  [hubMap.includes('virtualMemberRefresh') && hubMap.includes("publicStatus?.()?.sessions?.filter(item=>item.active)"), 'active Hub members refresh frequent virtual partner Hubs online'],
