...
assert(wrapper.includes("/service-worker-chat-repair-v245.js?v=chat-bubble-anchor-v342&purge=chat-bubble-anchor-v342"),'Checked-in worker wrapper lost the current stale-chat migration lane.');
