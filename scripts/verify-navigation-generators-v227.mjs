...
console.log(JSON.stringify({ok:true,version,revision:'navigation-generator-pwa-launch-session-v1-v350-chat-owner-single-repair',canonicalChatOwner:chatOwner,singleRouteAuthority:true,builderRouteFirst:true,builderIntegrityOrder:true,shellRepairOwner:'v293',retiredV225Absent:true,updaterFirstEntry:true,installedLaunchNeverInstaller:true,pwaLaunchSession:true,queryAuthorization:false,repairOnly:true,cacheDistinctRepair:true,workingCampusReturn:'v425'},null,2));
