...
assert(installedEntry.includes('async function installedLaunchAuthorized()'),'Installed entry must own one launch-session-aware authorization boundary.');
assert(installedEntry.includes('await installedLaunchAuthorized()'),'Installed entry must await PWA launch authorization before routing.');
