...
assert(wrapper.includes("/service-worker-chat-repair-v245.js?v=chat-css-contract-v343&purge=chat-css-contract-v343"),'Checked-in worker wrapper lost the current stale-chat migration lane.');
console.log(JSON.stringify({ok:true,version,revision:'navigation-generator-invariants-v425',singleRouteAuthority:true,builderRouteFirst:true,builderIntegrityOrder:true,builderCanonicalAfterRepair:true,coherenceCannotDowngrade:true,coherenceCannotRestoreRetiredChatOwners:true,compatibilityLauncherUsesContract:true,updaterFirstEntry:true,installedLaunchCampusRecovery:true,installedLaunchNeverInstaller:true,installerOpenPreempted:true,installerGuardOfflineCached:true,navigationLifecycle:'v424',workingCampusReturn:'v425',moduleSyntaxCheckedByWorkflow:true},null,2));