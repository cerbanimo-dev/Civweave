...
check('worker runs the current avatar-visible cache repair, v347 freeze cache-bust, and retains the v343 migration marker',workerEntry.includes("importScripts('/service-worker-chat-repair-v245.js?v=chat-avatar-visible-v346&purge=chat-avatar-visible-v346&freeze=mobile-chat-freeze-v347')")&&workerRepair.includes("const REVISION='chat-avatar-visible-v346'")&&workerRepair.includes("const FREEZE_REVISION='mobile-chat-freeze-v347'")&&workerEntry.includes('chat-css-contract-v343')&&workerRepair.includes('chat-css-contract-v343'));
