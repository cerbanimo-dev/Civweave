...
check('worker runs the current chat-bubble cache repair',workerEntry.includes("importScripts('/service-worker-chat-repair-v245.js?v=chat-css-contract-v343&purge=chat-css-contract-v343')")&&workerRepair.includes("const REVISION='chat-css-contract-v343'"));
