...
check('family AI loader can delegate opening through the canonical compatibility API',familyLoader.includes('CivweavePersistentGuideChatV215')&&familyLoader.includes('api.open({guide:target,prefill,focus:true})'));
