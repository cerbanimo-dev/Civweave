...
for(const token of [
  ...
  "settingsLoadPolicy:'visible-controls-preloaded-management-only-no-inference-v308'"
...
console.log(JSON.stringify({ok:true,revision:'realm-local-ai-visible-v308',bfcacheSafe:true,visibleControlsPreloaded:true,inferenceDormant:true},null,2));
