...
for(const token of [
  ...
  'function ensureLocalAISettingsManagement(layer)',
...
console.log(JSON.stringify({ok:true,revision:'realm-local-ai-visible-v320',bfcacheSafe:true,explicitActivation:true,visibleControlsOnDemand:true,managementAfterPaint:true,inferenceDormant:true,globalObserverUntouched:true,settingsOwner:'settings-v320',serviceRole:'downloaded-model-settings-content'},null,2));
