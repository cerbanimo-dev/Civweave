...
const finalizePattern=/\s*(?:\(self\.CommonweaveCriticalBootV201\|\|self\.CommonweaveCriticalBootV199\)|self\.CommonweaveCriticalBootV199)\?\.finalize\(\);\s*$/;
...
console.log(JSON.stringify({
  ok:true,
  revision:'v201-cache-busted-critical-coordinator-compatible',
