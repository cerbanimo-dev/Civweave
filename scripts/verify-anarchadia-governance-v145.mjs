...
const [html,css,ui,kernel,store,bridge,worker,pkgRaw,executor,testSource]=await Promise.all([
  read('public/app/anarchadia-governance-v145.html'),
  read('public/app/anarchadia-governance-v145.css'),
  read('public/app/anarchadia-governance-v145.js'),
  read('public/app/anarchadia-governance-kernel-v145.js'),
  read('public/app/anarchadia-governance-store-v145.js'),
...
for(const asset of ['anarchadia-governance-v145.html','anarchadia-governance-v145.css','anarchadia-governance-v145.js','anarchadia-governance-kernel-v145.js','anarchadia-governance-store-v145.js','anarchadia-governance-bridge-v145.js'])assert(worker.includes(asset),`Device package omits ${asset}`);
assert(worker.includes("DEVICE_REVISION='device-package-r27-local-sovereignty'"),'Current local-sovereignty device package revision is not active.');
