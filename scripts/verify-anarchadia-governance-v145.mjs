...
assert(worker.includes("INSTALL_REVISION='fullscreen-entry-r34'")&&worker.includes("CABINET_REVISION='fullscreen-software-r34'")&&worker.includes('anarchadia-sovereignty-kernel-v146.js'),'Governance is not installed inside the full-screen local-sovereignty package.');
