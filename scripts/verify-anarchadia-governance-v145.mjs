...
assert(installRevision==='direct-entry-r37'&&cabinetRevision==='direct-software-r35'&&deviceRevision==='device-package-r37-core'&&worker.includes('anarchadia-sovereignty-kernel-v146.js'),'Governance is not installed inside the current direct local-sovereignty core package.');
