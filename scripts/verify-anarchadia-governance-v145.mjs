...
assert(worker.includes("INSTALL_REVISION='direct-entry-r35'")&&worker.includes("CABINET_REVISION='direct-software-r35'")&&worker.includes('anarchadia-sovereignty-kernel-v146.js'),'Governance is not installed inside the direct local-sovereignty package.');
