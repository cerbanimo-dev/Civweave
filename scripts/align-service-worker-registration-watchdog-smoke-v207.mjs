...
const replacements=[
  ...
  ["    navigator:{standalone:false,onLine:true,serviceWorker},","    navigator:{standalone:false,onLine:true,userAgent:'Chrome watchdog test',serviceWorker},",'installer navigator user agent'],
];
let changed=false;
...
if(changed){
  ...
  console.log('Aligned watchdog smoke fixtures with browser operations, recovery timing, and navigator metadata.');
}else{
