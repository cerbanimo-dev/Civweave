...
assert.match(lifecycle,/document-lifecycle-v320-settings-service/,'settings lifecycle must identify as the V320 content service');
assert.match(lifecycle,/document-lifecycle-v320-single-menu/,'settings lifecycle must target the one V320 Settings menu');
...
assert.match(lifecycle,/activation:'settings-v320'/,'dormant lifecycle must identify the canonical Settings authority');
...
assert.match(lifecycle,/settingsEntryOwner:'settings-v320'/,'document lifecycle must identify V320 as Settings entry authority');
assert.match(lifecycle,/settingsOwner:'settings-v320'/,'document lifecycle must identify V320 as Settings presentation authority');
...
console.log(JSON.stringify({
  ...
  assertions:{
    ...
    settingsOpen:'v320-owner-then-post-paint-management',
    managementGate:'settings-content-only-no-inference-runtime',
