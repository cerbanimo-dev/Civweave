...
console.log(JSON.stringify({ok:true,revision:'canonical-campus-startup-v317',updaterFirstStart:true,canonicalSystems:5,navigationOwner:'system-routes-v227',interfaceRuntimeOwner:'core-interface-runtime-v1',settingsOwner:'settings-gateway-v317',settingsManagementActivation:'explicit-first-click',managementAfterPaint:true,globalObserverPatch:false},null,2));
