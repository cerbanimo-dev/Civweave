...
assert(routes.includes('function navigate(systemId')&&routes.includes('globalThis.CivweaveSystemRoutesV227=Object.freeze'),'Canonical five-system route owner must expose navigation directly.');
