...
async function syncSystem(system){
  ...
  return {playlistId:PLAYLISTS[system],trackCount:ids.length,tracks:ids,mismatches};
}

const systems=requestedSystem?[requestedSystem]:Object.keys(PLAYLISTS);
const manifest={version:1,revision:'radio-track-map-v241',generatedAt:new Date().toISOString(),systems:{}};
