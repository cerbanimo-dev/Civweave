...
assert.equal(guide.guide.education.acornsPerHour,10);
assert.equal(guide.guide.education.curriculumMinAcorns,5);
assert.equal(guide.guide.education.curriculumMaxAcorns,50);
...
assert.equal(guide.curriculumAcorns({hours:2,recommendedAcorns:37}),37);
