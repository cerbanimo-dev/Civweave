...
console.log(JSON.stringify({ok:true,chat:'minimizable-to-tray',dialogs:'sticky-and-bottom-close',livingSchool:'direct-lessons-and-opt-in-public-research',cerbanimo:'idempotent-ai-review',anarchadia:'compacted-state-lazy-ai-static-links',gemini:'interactions-transport-preserved'},null,2));
