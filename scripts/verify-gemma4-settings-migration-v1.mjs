...
includes(settings,"VERSION='1.0.17-model-settings-controller-v173-gemma4-browser-pack-coherence'",'model settings controller');
...
includes(settings,"const GEMMA4_BROWSER_PACK_VERSION='1.0.0-gemma4-browser-pack-coherence-v1'",'model settings controller');
...
includes(browserPack,"VERSION='1.0.0-gemma4-browser-pack-coherence-v1'",'Gemma browser handoff');
...
console.log('PASS Local Models boots LiteRT + Q4, retires Q2, updates the Premier Phone mid-range pack to LiteRT E2B/E4B, and routes multi-gigabyte LiteRT downloads through the browser-managed download/import flow instead of the failing legacy Cache Storage path.');
