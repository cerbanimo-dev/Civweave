...
const [gateway,lifecycle,living,runtime,mobile]=await Promise.all([
...
assert.ok(runtime.indexOf("'/app/settings-gateway-v317.js'")<runtime.indexOf("'/app/experience-orchestrator-v232.js'"),'Settings gateway must be assembled before general experience modules.');
