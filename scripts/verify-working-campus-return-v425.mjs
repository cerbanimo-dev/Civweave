...
assert(lifecycle.includes("settingsEntryOwner:'settings-v320'")&&lifecycle.includes("settingsOwner:'settings-v320'")&&lifecycle.includes('inputOwnership:false')&&lifecycle.includes('presentationOwnership:false'),'Document lifecycle regained Settings ownership.');
