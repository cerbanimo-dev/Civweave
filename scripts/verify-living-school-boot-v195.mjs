...
assert(critical.includes("VERSION='fellowfare-active-v203-parent-mobile-v205-cerbanimo-boundary-v204'"),'The combined FellowFare parent/mobile and Cerbanimo critical package is not active.');
...
console.log(JSON.stringify({ok:true,system:'living-school',mode:'flat',boot:'core-before-enhancements',content:'preserved-local-state',imageNavigation:'direct-and-repaired',aiMarks:'repaired',packageRevision:'v203-v205-combined'},null,2));
