...
assert(critical.includes("VERSION='living-school-flat-core-v203'"),'The critical package was not rotated for flat Living School.');
...
console.log(JSON.stringify({ok:true,system:'living-school',mode:'flat',boot:'core-before-enhancements',content:'preserved-local-state',imageNavigation:'direct-and-repaired',aiMarks:'repaired',packageRevision:'v203'},null,2));
