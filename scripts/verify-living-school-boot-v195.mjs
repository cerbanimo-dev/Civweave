...
assert(critical.includes("VERSION='fellowfare-active-v203-cerbanimo-boundary-v204'"),'The combined v204 critical package is not active.');
...
console.log(JSON.stringify({ok:true,system:'living-school',mode:'flat',boot:'core-before-enhancements',content:'preserved-local-state',imageNavigation:'direct-and-repaired',aiMarks:'repaired',packageRevision:'v203-v204-combined'},null,2));
