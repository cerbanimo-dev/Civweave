...
assert(!anarchadiaHtml.includes('/app/cabinet-home-v142.js')&&!anarchadiaHtml.includes('/app/cabinet-surfaces-v143.js'),'Anarchadia must boot its native citizen console without legacy overlays.');
...
assert(worker.includes('/app/cabinet-home-v142.js')&&worker.includes("GUIDE_REVISION='lazy-five-system-chat-r36-stable'"),'Fast core lost repaired cabinet/guide assets.');
await import('./verify-unified-ai-settings-v157.mjs');
console.log('System home verification passed with unified shared AI settings.');
