...
assert(realmHtml.includes('/app/cabinet-home-v142.css')&&realmHtml.includes('/app/cabinet-home-v142.js'),'Civweave/Cerbanimo lost cabinet home.');
...
assert(loader.includes('/app/assistant-runtime-v141.js')&&loader.includes('CivweaveAssistantV141'),'Lazy assistant loader is incomplete.');
