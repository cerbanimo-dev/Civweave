...
test('phone ledger is browser-local and does not require a host node', async () => {
...
test('installed entry creates the ledger runtime before navigation begins', async () => {
  ...
  assert.ok(phone > contribution, 'phone bootstrap must follow contribution runtime');
...
test('canonical phone surfaces reattach the ledger after navigation', async () => {
...
test('offline campus explicitly carries every phone-ledger runtime', async () => {
