...
assert(guard.includes("owner:'themed-system-nav-v178'"),'The universal themed navbar must be the explicit sole navigation owner.');
...
assert(guard.includes('CivweavePersistentShellActionsV1'),'The redundant shell-action observer must be suppressed on Cerbanimo.');
...
console.log('Cerbanimo universal-nav stability contract passed: canonical portraits are used, redundant navigation observers are suppressed, task clicks do not trigger video resolution, and quest rendering remains frame-bounded.');
