...
assert(shell.includes('data-build="persistent-system-shell-v1-r9-local-model-stage-bridge"'),'Persistent shell must use the current full-height, iframe-aware settings build.');
