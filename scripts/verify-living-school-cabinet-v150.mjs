...
for(const token of ['commonweave.living-school.cabinet.v150','commonweave.realm-console.v140','Explicit confirmation is required','Accepted status requires evidence or a review ID','living-school.send-quest','living-school-project-gate','living-school-public-passport.json','living-school-cabinet-backup.json'])assert(runtime.includes(token),`Living School state or safety contract missing ${token}`);
