...
assert.match(critical,/(?:living-school-lesson-nav-v202|fellowfare-active-v203)-fast-runtime-proxy|fellowfare-active-v203-(?:cerbanimo-boundary-v204|parent-mobile-v205-cerbanimo-boundary-v204)/,'critical boot revision must retain the frozen runtime proxy repair');
assert.ok(critical.includes("'/app/fast-interactive-runtime-v192.js'"),'critical boot must refresh the corrected runtime');
assert.match(worker,/service-worker-critical-v199\.js\?v=(?:fast-runtime-proxy-v202|fellowfare-active-v203|fellowfare-parent-mobile-v205)/,'the registered worker must force an imported-script refresh');
