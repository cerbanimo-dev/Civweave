...
const retired=api.render({
  ...
  failed:[],
  failedCount:0,
  skipped:Array.from({length:17},(_,index)=>({pathname:`/retired-${index}.js`,reason:'stale-not-rediscovered'})),
  skippedCount:17
});
...
console.log(JSON.stringify({
  ok:true,
  revision:'offline-campus-status-v210-retired-completion-v246',
  runtimeVersion:api.version,
  legacyAttempted:205,
  legacyDownloaded:186,
  failedCount:19,
  retiredScenario:{reportedTotal:234,downloaded:217,retired:17,currentTotal:retired.total,ready:retired.ready},
