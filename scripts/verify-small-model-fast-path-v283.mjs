...
console.log(JSON.stringify({ok:true,revision:'small-model-fast-path-v283-on-v286',features:{embeddedLocalPrimary:true,adaptiveOutputSlices:true,clippingValidation:true,boundedContinuation:true,streamedContinuation:true,thinkingProfilesPreserved:true,wasmPerformancePreserved:true}},null,2));
