...
console.log(JSON.stringify({ok:true,revision:'small-model-fast-path-v307-coherent-bootstrap',features:{embeddedLocalPrimary:true,adaptiveOutputSlices:true,clippingValidation:true,boundedContinuation:true,streamedContinuation:true,thinkingProfilesPreserved:true,wasmPerformancePreserved:true,stalledWebGPUFallback:true,webgpuSessionQuarantine:true,freshWorkerFallback:true,promptBudgetEnforced:true,boundedStartup:true,coherenceReload:true,packageRevisionGuard:true,componentCompatibility:'capability-contract-v307'}},null,2));