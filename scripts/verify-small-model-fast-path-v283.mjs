...
console.log(JSON.stringify({ok:true,revision:'small-model-fast-path-v288-on-v287',features:{embeddedLocalPrimary:true,adaptiveOutputSlices:true,clippingValidation:true,boundedContinuation:true,streamedContinuation:true,thinkingProfilesPreserved:true,wasmPerformancePreserved:true,componentCompatibility:'capability-contract-v288'}},null,2));
