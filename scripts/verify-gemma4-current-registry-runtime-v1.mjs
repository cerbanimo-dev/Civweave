...
assert.equal(sandbox.CivweaveGemma4PhonePerformanceCoreV1.currentRegistryOnlyAuthority,'1.0.2-gemma4-current-registry-authority-v1-stable-composition');
...
const scriptRef='/app/local-ai/gemma4-current-registry-authority-v1.js?v=1.0.2-stable-composition';
...
assert.equal(sandbox.CivweaveGemma4CurrentRegistryAuthorityV1.stableAssistantComposition,true);
assert.match(sandbox.CivweaveGemma4CurrentRegistryAuthorityV1.requestAuthoritySource,/1\.0\.1-stable-composition/);

console.log(JSON.stringify({ok:true,currentModels:[FAST_E2,FAST_E4],legacyAliasesRequired:false,cachedLegacyRegistryRecovered:true,currentRegistrationStillRequired:true,parentAndCampusLoaded:true,formattedOutputAuthority:true,stableAssistantComposition:true},null,2));
