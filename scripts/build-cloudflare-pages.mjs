...
// Pages source is authoritative on every branch. The legacy release synchronizers
// encode the retired v229 single-shell navigation contract and can rewrite or
// reject the current v230 shared-navbar graph. Keep those mutators out of the
// Cloudflare Pages packaging path so production deploys the same checked-in
// source graph that staging validates.
console.log('[Civweave] Pages source is authoritative; skipping retired single-shell release synchronizers.');
