...
assert.match(family,/LOCAL_AI_BOOTSTRAP_REVISION='1\.0\.115-local-ai-bootstrap-v302-session-handoff'/,'family loader must pin the current bootstrap revision');
...
assert.match(family,/CivweaveLocalAIBootstrapV266\?\.revision===LOCAL_AI_BOOTSTRAP_REVISION/,'family loader must reject a stale bootstrap global');
