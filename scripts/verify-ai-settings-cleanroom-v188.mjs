...
requires(sources.controller,["const LAYER_ID='cw-ai-settings-cleanroom-v188'","authority:'ai-settings-cleanroom-v188'","eventOwnership:'single-cleanroom-controller'","presentation:'cleanroom-v188'",'providerRuntimeOnOpen:false','providerRuntimeAvailable:false','providerTestsAvailable:false','modelDiscoveryAvailable:false','singlePassOpen:true','function open(launcher)','function close(reason=','globalThis.CommonweaveAISettingsCleanroomV188=api','globalThis.CommonweaveModelSettingsControllerV173=api'],'controller');
...
requires(sources.boundary,[`const VERSION='${releaseVersion}';`,`const ADDITIONS_VERSION='v${releaseVersion}-canonical-core-only-v226';`,"const REVISION='five-system-boundary-v227'",'const LEGACY_SCRIPTS=[',"'/app/system-routes-v227.js'","'/app/model-settings-controller-v173.js'","'/app/settings-delegation-v175.js'","canonicalPolicy:'five-system-first-class-routes-commonweave-core-only'",'canonicalSystemCount:5','canonicalAutoScripts:0','if(canonicalAppSurface()||!liveHead())return false;'],'install boundary');
...
const routeImport="importScripts('/app/system-routes-v227.js",cleanImport="importScripts('/service-worker-living-school-cleanroom-v218.js",coreImport="importScripts('/service-worker-core-v208.js",canonicalImport="importScripts('/service-worker-canonical-navigation-v227.js";
requires(sources.wrapper,[routeImport,cleanImport,coreImport,canonicalImport],'active worker wrapper');
...
console.log(JSON.stringify({ok:true,releaseVersion,revision:'cleanroom-capability-contract-v1.0.16',controllerAuthority:'single-cleanroom-controller',openPath:'synchronous-local-dom-only',canonicalBoundary:'five-first-class-routes-commonweave-core-only',canonicalSystemCount:5,legacyCompatibility:true,mutationObserver:false,polling:false,timers:false,diagnosticsRuntime:false,providerRuntimeOnOpen:false,providerTestsAvailable:false,modelDiscoveryAvailable:false,installedPackageMode:'v227-navigation-v218-cleanroom-v208-core',launcherSurfaces},null,2));
