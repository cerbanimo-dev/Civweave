...
check('runtime selects v300 worker and preserves compatibility plus tier fallback',runtime.includes("VERSION='1.0.111-local-ai-runtime-v300-windows-memory'")&&runtime.includes("worker-v266.js?v=1.0.111-v300-windows-memory")&&runtime.includes('compatibilitySpec')&&runtime.includes('backend-fallback-download')&&runtime.includes('installedTierFallbacks'));
