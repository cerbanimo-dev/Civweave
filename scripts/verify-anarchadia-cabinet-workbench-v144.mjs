...
assert(worker.includes("DEVICE_REVISION='device-package-r27-local-sovereignty'"),'Shared local-sovereignty device package revision was not activated.');
...
console.log(JSON.stringify({ok:true,cabinet:'anarchadia',surfaces:['citizen-console','governance-workbench'],classicRoutes:8,devicePackage:'r27-local-sovereignty',serviceWorkerAuthority:'root-only',sourceBoundary:'cabinet-only compatibility loader',archivedSceneRequests:false},null,2));
