...
console.log(JSON.stringify({ok:true,cabinet:'anarchadia',surfaces:['citizen-console','governance-workbench'],classicRoutes:8,devicePackage:'r24',serviceWorkerAuthority:'root-only',sourceBoundary:'cabinet-only compatibility loader',archivedSceneRequests:false},null,2));
