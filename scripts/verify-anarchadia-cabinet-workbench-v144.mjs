...
console.log(JSON.stringify({ok:true,cabinet:'anarchadia',surfaces:['citizen-console','governance-workbench'],classicRoutes:9,devicePackage:'r25-anarchadia-fellowfare',serviceWorkerAuthority:'root-only'},null,2));
