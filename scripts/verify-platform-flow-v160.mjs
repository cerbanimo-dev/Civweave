...
for(const token of ['data-civweave-resolved-theme="dark"','[data-cw160-theme]','.ff160-request-card'])assert(css.includes(token),`Platform experience CSS missing ${token}`);
