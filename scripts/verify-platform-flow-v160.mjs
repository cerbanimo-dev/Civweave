...
for(const token of ['data-commonweave-resolved-theme="dark"','[data-cw160-theme]','.ff160-request-card'])assert(css.includes(token),`Platform experience CSS missing ${token}`);
...
console.log(JSON.stringify({ok:true,darkMode:'preserved',rook:'private-preview-and-funding-preserved',livingSchool:'cleanroom-single-owner-v218'},null,2));
