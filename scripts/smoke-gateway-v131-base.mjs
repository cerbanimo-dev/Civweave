...
const PORT=18792,origin=`http://127.0.0.1:${PORT}`,VERSION='1.0.140',BUILD='1.0.140-install-only-fullscreen-family-gateway';
...
try{
  ...
  console.log(JSON.stringify({ok:true,version:VERSION,build:BUILD,requiredCoreAssetCount:requiredAssets.length,defaultProvider:'deterministic',settingsPresentation:'cleanroom-v188-v318',settingsDelegation:'retired-v317-single-gateway',nativeDialog:false,outsideTap:'safe-close',settingsTransformerWork:false,providerRuntimeOnOpen:false,providerTestsAvailable:false,modelDiscoveryAvailable:false,captureListener:false,mutationObserver:false,polling:false,settingsPaintBeforeInferenceCancellation:true,settingsCancellationScheduling:'after-paint-only',campusIconPixels:64,campusShell:'compact-v235',manualFirstInstaller:true},null,2));
