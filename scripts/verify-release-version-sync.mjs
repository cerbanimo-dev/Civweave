...
const required=[
  ...
  [workerWrapper,`service-worker-core-v208.js?v=${version}-chat-convergence-v250-installer-brand-v1-working-campus-return-v425`,'worker core import'],
...
check(campusHtml.includes('/app/install-boundary-v146.js?v=chat-convergence-v250-navigation-lifecycle-v424'),'Working Campus boundary cache identity regressed.');
...
for(const token of [
  ...
  'service-worker-core-v208.js?v=${version}-chat-convergence-v250-installer-brand-v1-working-campus-return-v425',
...
])check(syncSource.includes(token),`Release synchronizer would erase the return repair: missing ${token}`);
