...
try{
  ...
  assert(files.core.includes("const BUILD = 'lightweight-shell-v208-installer-brand-v1'")&&files.core.includes('DOWNLOAD_OFFLINE_PACKAGE'),'retained lightweight/offline core is incomplete');
