...
try{
  ...
  assert(files.coherence.includes("const CW_CODE_COHERENCE_VERSION = '1.0.91-code-coherence-v288-language-v1'")&&files.coherence.includes('event.stopImmediatePropagation()')&&files.coherence.includes("'/app/local-ai/bootstrap-v266.js'"),'v288 executable-code coherence layer is incomplete');
