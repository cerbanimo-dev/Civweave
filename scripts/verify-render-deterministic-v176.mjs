...
assert(pkg.version==='1.0.5','Render package must publish v1.0.5.');
...
console.log(JSON.stringify({ok:true,version:'1.0.5',renderBuild:'npm install --omit=dev && npm run build:release',node:'22.x',normalDependencyCount:0,transformerInstall:'explicit laboratory command only'},null,2));
