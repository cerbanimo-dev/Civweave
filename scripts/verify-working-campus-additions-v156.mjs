...
assert(installer.includes('/service-worker-v156.js')&&installer.includes('GET_ADDITIONS_STATUS')&&installer.includes('working-campus-additions-v156'),'Installer does not require the additive package.');
