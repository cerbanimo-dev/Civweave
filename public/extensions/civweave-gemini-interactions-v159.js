...
function baseResult(original,request,config,profile,elapsedMs){
  return{
    schema:original.resultSchema||'civweave-model-result-1.0',
...
install();
globalThis.CivweaveGeminiInteractionsV159={version:VERSION,wrap,generateWithInteractions,get runtime(){return installedRuntime}};
})();
