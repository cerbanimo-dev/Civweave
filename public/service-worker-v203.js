...
// family-nav-single-owner-r1: themed-system-nav-v178 is the sole five-system navigation owner; retired family tray assets are absent.
'use strict';
...
importScripts('/service-worker-core-v208.js?v=1.0.162-chat-convergence-v250-installer-brand-v1-working-campus-return-v425-install-only-pwa-v1-family-nav-single-owner-r1');
