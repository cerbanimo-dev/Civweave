...
'use strict';
importScripts('/app/system-routes-v227.js?v=1.0.115-five-system-route-contract-v227');
...
importScripts('/service-worker-core-v208.js?v=1.0.115-chat-convergence-v250');
...
importScripts('/service-worker-radio-core-v305.js?v=1.0.114-radio-core-shell-v305');
