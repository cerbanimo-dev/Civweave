// GENERATED: five-system route contract v227 + downloaded-runtime boundary v266 + living-school clean-room cache boundary + retained lightweight shell core + offline-campus-current-graph-v238 policy fast-background-v241 + campus-retired-completion-v246 + release-coherence-v226 + navigation-redirect-safety-v224 + shell-self-repair-v225 + canonical-navigation-v266 + chat-convergence-v250
'use strict';
importScripts('/app/system-routes-v227.js?v=1.0.58-five-system-route-contract-v227');
importScripts('/service-worker-offline-runtime-boundary-v266.js?v=1.0.58-downloaded-runtime-v266');
importScripts('/service-worker-living-school-cleanroom-v218.js?v=living-school-cleanroom-v218');
importScripts('/service-worker-core-v208.js?v=1.0.58-chat-convergence-v250');
