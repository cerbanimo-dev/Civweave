...
// guild-chat-usage-v1: selected Guild neuron balance and estimated conversations stay visible in canonical chats and update from the active capacity session.
...
'use strict';
importScripts('/app/system-routes-v227.js?v=1.0.163-five-system-route-contract-v227-guild-chat-usage-v1');
