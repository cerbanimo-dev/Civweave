...
importScripts('/service-worker-core-v208.js?v=1.0.147-chat-convergence-v250-installer-brand-v1-working-campus-return-v425-desktop-reload-storm-v428-install-only-pwa-v1');
...
importScripts('/service-worker-chat-repair-v245.js?v=chat-avatar-visible-v346&purge=chat-avatar-visible-v346&freeze=mobile-chat-freeze-v347');
