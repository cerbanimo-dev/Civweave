...
// Installed cache migration override: purge retired chat/overlay assets and stale launcher geometry with chat-bubble-anchor-v342.
'use strict';
importScripts('/app/system-routes-v227.js?v=1.0.106-five-system-route-contract-v227');
...
importScripts('/service-worker-core-v208.js?v=1.0.106-chat-convergence-v250');
...
importScripts('/service-worker-radio-core-v305.js?v=1.0.106-radio-core-shell-v305');
