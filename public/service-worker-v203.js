// GENERATED: five-system route contract v227 + living-school clean-room cache boundary + retained lightweight shell core + offline-campus-current-graph-v238 policy fast-background-v241 + campus-retired-completion-v246 + release-coherence-v226 + navigation-redirect-safety-v224 + shell-self-repair-v225 + canonical-navigation-v227 + chat-convergence-v250 + local-model-background-v271-integrity
'use strict';
...
importScripts('/service-worker-local-model-download-v267.js?v=1.0.67-local-model-background-v271-integrity');
