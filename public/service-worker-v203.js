// GENERATED: five-system route contract v227 + living-school clean-room cache boundary + local-ai-code-coherence-v307 + code-coherence-v288-language-v1 + retained lightweight shell core + installed-pwa-launch-v294-campus-recovery + installer-state-machines-v280 + shell-integrity-v281 + radio-core-shell-v305 + installed-shell-repair-v293 + offline-campus-current-graph-v280 current-manifest-only-v282 + campus-retired-completion-v246 + release-coherence-v226 + navigation-redirect-safety-v224 + shell-self-repair-v225 + canonical-navigation-v227 + chat-avatar-visible-v346 + chat-interaction-safe-v348 + mobile-ai-hardening-v302 + local-model-background-v267 + open-learning-media-v1 + working-campus-return-v425 + desktop-reload-storm-v428 + boot-recovery-v426 + atomic-update-handoff-v427 + install-only-pwa-v1
'use strict';
importScripts('/app/system-routes-v227.js?v=1.0.149-five-system-route-contract-v227');
importScripts('/service-worker-living-school-cleanroom-v218.js?v=living-school-cleanroom-v218');
importScripts('/service-worker-local-ai-coherence-v307.js?v=1.0.149-local-ai-code-coherence-v307');
importScripts('/service-worker-code-coherence-v288.js?v=1.0.91-code-coherence-v288-language-v1');
importScripts('/service-worker-core-v208.js?v=1.0.149-chat-convergence-v250-installer-brand-v1-working-campus-return-v425-install-only-pwa-v1');
...
importScripts('/service-worker-radio-core-v305.js?v=1.0.149-radio-core-shell-v305-playlist-only-v246');
...
importScripts('/service-worker-chat-repair-v245.js?v=chat-avatar-visible-v346&purge=chat-avatar-visible-v346&freeze=chat-interaction-safe-v348');
