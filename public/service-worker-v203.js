...
// mobile-chat-visual-viewport-v1: the full-screen guide surface follows Android's visual viewport while the keyboard is open so the composer remains on-screen.
...
importScripts('/service-worker-chat-repair-v245.js?v=chat-avatar-visible-v346&purge=chat-avatar-visible-v346&freeze=mobile-chat-main-thread-quiescence-v349&layout=mobile-chat-visual-viewport-v1&party=lazy-v353&model=selected-local-minilm-v357&failover=server-auto-local-failover-v358&passover=guide-capability-passover-v361');
