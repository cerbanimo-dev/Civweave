'use strict';
(()=>{
  const VERSION='avatar-expression-offline-v344';
  ...
  self.CivweaveAvatarExpressionOfflineV344=Object.freeze({version:VERSION,cache:CACHE,assets:ASSETS.slice(),modelCache:'civweave-model-generative-v266',policy:'code-network-first-assets-cache-first',alreadyDownloadedTinyLMSurvivesOffline:true});
})();
