'use strict';
const VERSION='1.0.6';
const CACHE_REVISION='direct-family-r43-settings-single-pass';
...
const INSTALL_REVISION='direct-entry-r43-settings-single-pass';
const LEDGER_HYDRATION_REVISION='direct-software-r35';
const AI_REVISION='self-contained-settings-v182-single-pass-fixed-ort';
