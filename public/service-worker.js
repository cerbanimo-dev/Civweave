...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v7-single-shell-context';
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v7-single-shell-context');