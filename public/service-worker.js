...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v9-ai-quest-authority';
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v9-ai-quest-authority');