...
const DEVICE_REVISION='device-package-r24-fellowfare';
...
const CORE=[
  ...
  '/app/local-first-policy-v131.js','/app/manifest.webmanifest',
  ...
  '/app/logos/fellowfare.png','/app/logos/fellowfare-v2.webp',
