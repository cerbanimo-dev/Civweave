...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v18-kamiya-gemini-provider-authority-gate';
...
const CORE=[
  ...
  '/app/server-ai-router-v301.js','/app/server-ai-output-normalizer-v1.js','/app/cerbanimo-chat-quest-capability-v1.js','/app/cerbanimo-chat-quest-capability-v2.js','/app/cerbanimo-chat-quest-capability-v3.js',
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v18-kamiya-gemini-provider-authority-gate');