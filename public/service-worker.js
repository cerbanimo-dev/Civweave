...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v12-kamiya-quota-failover';
...
const CORE=[
  ...
  '/app/server-ai-router-v301.js','/app/server-ai-output-normalizer-v1.js','/app/cerbanimo-chat-quest-capability-v1.js',
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v12-kamiya-quota-failover');