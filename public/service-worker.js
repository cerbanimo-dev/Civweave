...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v8-litert-gemma4-fast';
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v8-litert-gemma4-fast');