...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v19-selected-provider-authority-output-sanitizer';
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v19-selected-provider-authority-output-sanitizer');