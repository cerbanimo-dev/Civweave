...
const CIVWEAVE_ROOT_WORKER_BRIDGE='root-worker-bridge-v31-mandatory-gemma-intake';
...
const CORE=[
  ...
  '/app/guide-chat-surface-v350.js','/app/shared-guide-surface-v236.js','/app/guide-generation-floor-v1.js','/app/guide-stream-thinking-v249.js','/app/guide-generation-tracker-v1.js','/app/generation-lifecycle-v1.js','/app/generation-failure-inspector-v1.js','/app/local-guide-control-bypass-v1.js','/app/unified-chat-system-v1.js','/app/weaveling-plan-materialization-v265.js','/extensions/civweave-weaveling-plan-json-v190.js',
...
importScripts('/service-worker-v203.js?v=root-worker-bridge-v31-mandatory-gemma-intake');
