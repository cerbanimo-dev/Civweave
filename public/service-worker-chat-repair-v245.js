...
const REVISION='guild-live-balance-v2';
...
const HARDENING_REVISION='mobile-chat-composer-stack-v363';
const MOBILE_VIEWPORT_REVISION='mobile-chat-visual-viewport-v1.0.1-long-thread-fit';
...
const CERBANIMO_QUEST_CHAT_REVISION='kamiya-quest-chat-v3-recoverable-json';
const THREAD_TABS_REVISION='saved-tabs-contained-v354';
...
// Keep activation bounded, but always evict the small runtime files whose
