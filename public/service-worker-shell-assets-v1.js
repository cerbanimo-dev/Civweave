;(()=>{
'use strict';
const REVISION='shell-assets-v1-repair-v4-family-navigation-required';
...
for(const pathname of [...OPTIONAL,...OPTIONAL_FAMILY_NAV]){
...
self.CivweaveShellAssetsV1=Object.freeze({
  ...
  optional:[...OPTIONAL,...OPTIONAL_FAMILY_NAV],
