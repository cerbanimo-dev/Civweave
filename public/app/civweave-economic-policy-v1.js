...
const STABILITY=Object.freeze({
  ...
  invariant:'No hidden sink, burn, demurrage, issuance cap, or other deflationary mechanism is enabled by this registry. Future stability levers must be explicit governed variables.',
...
globalThis.CivweaveEconomicPolicyV1=Object.freeze({version:VERSION,schema:SCHEMA,governance:GOVERNANCE,stability:STABILITY,variables:rows,snapshot,candidateChange});
