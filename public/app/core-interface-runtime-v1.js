...
const requestedRelease=/^\d+\.\d+\.\d+$/.test(new URLSearchParams(globalThis.location?.search||'').get('version')||'')?new URLSearchParams(globalThis.location?.search||'').get('version'):'1.0.161';
