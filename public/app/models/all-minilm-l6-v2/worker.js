...
async function configure(){
  ...
  self.postMessage({type:'progress',progress:{status:'backend-verified',loaderBytes:loader.bytes,wasmBytes:wasm.bytes,wasmMagic:wasm.magic,source:'installed-device-package'}});
  return{loader,wasm};
}
