...
const FALLBACK_VERSION='1.0.150';
...
globalThis.CivweaveInstalledEntryV146=Object.freeze({version:'1.0.150-boot-recovery-v426-legal-consent-v1-install-only-pwa-v1',installedDisplay,explicitInstalled,resolveReleaseVersion,refreshWorker,safeRecoveryRequested,ensureLegalConsent,installerUrl,browserRuntimePolicy:'installed-display-only'});
})();