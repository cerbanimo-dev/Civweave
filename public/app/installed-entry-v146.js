...
const target=system==='commonweave'?'/app/fullscreen-family-v104.html?system=commonweave':(sites[system]||sites.commonweave);
const destination=new URL(target,location.origin);destination.searchParams.set('installed','1');if(localDeveloper())destination.searchParams.set('developer','1');location.replace(destination.href);
})();
