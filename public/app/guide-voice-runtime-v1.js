...
const VERSION='1.1.6-guide-voice-runtime-v1-parakeet-no-proxy-worker';
...
const SPEECH_EXECUTOR_VERSION='1.0.5-parakeet-speech-executor-v1-no-proxy-worker';
const SPEECH_EXECUTOR_PATH='/app/local-ai/parakeet-speech-executor-v1.js?v=1.0.5';
