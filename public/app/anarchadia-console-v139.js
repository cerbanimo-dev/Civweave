...
async function providerPatch(p){
  const runtime=globalThis.CommonweaveModelRuntime||parent?.CommonweaveModelRuntime;const config=runtime?.readSharedConfig?.('agentic');
