...
const ADDITIONS_VERSION='v181-settings-self-contained';
const PREVIOUS_ADDITIONS_VERSION='v180-settings-freeze-boundary';
const FAST_CORE_COMPATIBILITY_REVISION='v181-v106-self-contained-settings';
const SETTINGS_STABILITY_REVISION='v181-no-open-imports';
const SETTINGS_CONTROLLER_REVISION='v181-self-contained-single-authority';
const SETTINGS_RUNTIME_REVISION='v181-provider-runtime-on-action-only';
