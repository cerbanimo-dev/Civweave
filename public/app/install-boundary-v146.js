...
const ADDITIONS_VERSION='v175-deterministic-single-ai-settings';
const PREVIOUS_ADDITIONS_VERSION='v174-settings-single-owner-assets';
const FAST_CORE_COMPATIBILITY_REVISION='v175-no-active-transformer';
const SETTINGS_STABILITY_REVISION='v175-single-ai-surface';
const SETTINGS_CONTROLLER_REVISION='v175-deterministic-single-authority';
