...
- Added a stewardship dashboard for every monitored intention, including health, forecast, risks, next decisions, live gap matches, and communication policy.
- Added per-intention escalation thresholds, monitoring switches, and executive-check-in cadence.
- Added threshold-gated executive check-ins delivered into the persistent Quad conversation.
