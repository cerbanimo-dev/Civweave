...
const VERSION='1.0.78-working-campus-topbar-v243-federation-finder-v268-no-localhost-v1';
...
html[data-civweave-system-route="civweave"] main.app>header.top,html[data-civweave-system="civweave"] main.app>header.top{grid-template-columns:minmax(0,1fr) minmax(0,1fr)!important;grid-template-areas:"brand brand" "modes modes" "map settings" "review theme"!important;top:max(4px,env(safe-area-inset-top))!important;gap:6px!important}
html[data-civweave-diagnostics="true"][data-civweave-system-route="civweave"] main.app>header.top,html[data-civweave-diagnostics="true"][data-civweave-system="civweave"] main.app>header.top{grid-template-areas:"brand brand" "modes modes" "map settings" "review theme" "diagnostics diagnostics"!important}
...
#${MAP_BUTTON_ID}{min-width:0!important;width:100%!important;padding:8px 9px!important}
...
html[data-civweave-system-route="civweave"] #cw-persistent-guide-chat-v215,html[data-civweave-system="civweave"] #cw-persistent-guide-chat-v215{top:calc(var(--cw-working-campus-topbar-height,194px) + env(safe-area-inset-top) + 10px)!important}
}
...
function installMapButton(){
  ...
  document.documentElement.dataset.civweaveWorkingCampusTopbar='v243-mobile-v248-federation-finder-v268-no-localhost-v1';
  return true
}
