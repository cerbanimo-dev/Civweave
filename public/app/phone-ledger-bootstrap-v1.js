...
async function ensureRuntime(){await ensureScript(TRANSPORT_PATH,'CivweaveLocalMeshV146');const contribution=await ensureScript(CONTRIBUTION_PATH,'CivweaveContributionMeshV1');await contribution.ready();await ensureSecurity();const guarded=await ensureShipGuard();await ensureScript(SETTINGS_ENTRY_PATH,'CivweaveContributionSecuritySettingsV1');return guarded}
