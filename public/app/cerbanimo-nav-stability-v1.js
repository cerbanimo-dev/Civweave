(()=>{
'use strict';
const VERSION='1.0.3-cerbanimo-nav-stability-direct-shell';
...
if(embedded){
  ...
  globalThis.CivweaveCerbanimoNavStabilityV1=Object.freeze({version:VERSION,ensure:()=>false,standalone,embedded,directShell:true});
  return;
}
...
globalThis.CivweaveCerbanimoNavStabilityV1=Object.freeze({version:VERSION,ensure,standalone,embedded,directShell:true});
})();
