...
const api=Object.freeze({version:VERSION,revision:REVISION,draftSchema:DRAFT_SCHEMA,projectionSchema:PROJECTION_SCHEMA,systems:Object.freeze(SYSTEM_IDS.slice()),eventTypes:Object.freeze(Object.keys(EVENT_POLICIES)),normalizeSystemId,identifySystem,eventPolicy,createDraft,validateDraft,publish,outbox,acknowledgeDrafts,validateProjection,receiveProjection,projectionInbox,decideProjection,decisions,status});
