(()=>{
'use strict';
const VERSION='1.0.5-working-campus-home-relocation-v441-browser-pack-explicit-files';
...
const BROWSER_PACK_IMPORT_SRC='/app/local-ai/browser-pack-pwa-import-v1.js?v=1.1.0-explicit-files';
...
function ensureBrowserPackPwaImport(){
  if(globalThis.CivweaveBrowserPackPwaImportV1?.ensureBridge&&globalThis.CivweaveBrowserPackPwaImportV1?.version?.startsWith?.('1.1.0-'))return true;
