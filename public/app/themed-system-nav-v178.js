...
const VERSION='1.0.143-five-system-navigation-v227';
...
function href(item){return ROUTES?.urlFor?.(item.id,{version:'1.0.143',source:currentSystem()||'navigation'}).href||item.fallback}
...
function mount(){
  ...
  nav.addEventListener('click',event=>{
    ...
    ROUTES.navigate(link.dataset.system,{version:'1.0.143',source:current});
  });
