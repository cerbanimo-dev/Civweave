(()=>{
'use strict';
const VERSION='1.0.4-lazy-ai-r36-stable';
...
async function openSettings(){const done=busy('Loading universal AI settings…');try{await ensure();return globalThis.CommonweaveModelSettingsV133.open()}catch(error){reset(error.message);throw error}finally{done()}}
