(()=>{
'use strict';
const VERSION='1.0.68-local-ai-runtime-v274-cache-only';
const WORKER='/app/local-ai/worker-v266.js?v=1.0.68-v274';
...
const api=Object.freeze({version:VERSION,activeSpec,ready,generate,shutdown,streaming:true,cacheOnly:true});
globalThis.CivweaveLocalModelRuntimeV266=api;
dispatchEvent(new CustomEvent('civweave:local-model-runtime-ready',{detail:{version:VERSION,dormant:true,cacheResolved:true,streaming:true,cacheOnly:true}}));
})();
