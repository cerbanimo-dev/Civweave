(()=>{
'use strict';
const VERSION='1.0.67-local-ai-runtime-v271-streaming';
const WORKER='/app/local-ai/worker-v266.js?v=1.0.67-v271';
...
dispatchEvent(new CustomEvent('civweave:local-model-runtime-ready',{detail:{version:VERSION,dormant:true,cacheResolved:true,streaming:true}}));
})();
