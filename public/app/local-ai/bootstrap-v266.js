(()=>{
'use strict';
const VERSION='1.0.73-local-ai-bootstrap-v275-backend-fallback';
...
const files=[
  ...
  ['/app/local-ai/model-registry-v266.js?v=1.0.73-v275',()=>globalThis.CivweaveLocalModelRegistryV266?.version==='1.0.73-local-ai-registry-v275-backend-fallback'],
