(()=>{
'use strict';
const VERSION='1.0.67-local-ai-bootstrap-v271-streaming';
...
const files=[
  ...
  ['/app/local-ai/runtime-v266.js?v=1.0.67-v271',()=>globalThis.CivweaveLocalModelRuntimeV266?.version==='1.0.67-local-ai-runtime-v271-streaming'],
  ...
  ['/app/local-ai/test-pulse-v269.js?v=1.0.67-v271',()=>globalThis.CivweaveLocalModelTestPulseV269?.version==='1.0.67-local-model-test-pulse-v271-repair-stream']
];
