...
const REVISION='1.0.88-local-ai-bootstrap-v283-small-model-fast-path';
...
const files=[
  ...
  ['/app/local-ai/runtime-v266.js?v=1.0.88-v286-v283',()=>globalThis.CivweaveLocalModelRuntimeV266?.version==='1.0.86-local-ai-runtime-v286-wasm-performance'&&globalThis.CivweaveLocalModelRuntimeV266?.revision===REVISION.replace('bootstrap','runtime')&&globalThis.CivweaveLocalModelRuntimeV266?.smallModelFastPath===true],
  ['/app/local-ai/runtime-bridge-v266.js?v=1.0.88-v283',()=>globalThis.CivweaveLocalModelBridgeV266?.version==='1.0.83-local-ai-bridge-v282-health-fallback'&&globalThis.CivweaveLocalModelBridgeV266?.revision==='1.0.88-local-ai-bridge-v283-small-model-fast-path'&&globalThis.CivweaveLocalModelBridgeV266?.continuationValidation===true],
