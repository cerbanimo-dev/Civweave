...
const VERSION='1.0.56-shared-guide-surface-v236-v264-learning-path-intent';
...
loadStyle('/app/mobile-guide-scroll-v256.css?v=1.0.56-v256');
load('/app/gemini-device-direct-v257.js?v=1.0.56-v257',()=>{
  load('/extensions/civweave-gemini-interactions-v159.js?v=1.0.56-v257');
});
load('/app/shared-guide-surface-v236-core-v244.js?v=1.0.56-v264',()=>{
  load('/app/shared-chat-face-icons-v255.js?v=1.0.56-v257',()=>{
    try{dispatchEvent(new CustomEvent('civweave:shared-chat-face-icons-ready',{detail:{version:VERSION}}))}catch{}
  });
  load('/app/living-school-chat-workbench-v255.js?v=1.0.56-v264-new-path-intent',()=>{
