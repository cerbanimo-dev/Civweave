...
const VERSION='1.0.156-shared-guide-surface-v236-local-provider-authority';
...
function install(){
  ...
  load('/app/local-provider-authority-v1.js?v=1.0.0-local-provider-authority',null,()=>Boolean(globalThis.CivweaveLocalProviderAuthorityV1));
