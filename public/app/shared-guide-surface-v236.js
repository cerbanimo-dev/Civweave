...
const VERSION='1.0.157-shared-guide-surface-v236-gemma4-runtime-floor';
...
function install(){
  ...
  load('/app/local-provider-authority-v1.js?v=1.0.1-gemma4-runtime-floor',null,()=>globalThis.CivweaveLocalProviderAuthorityV1?.version==='1.0.1-local-provider-authority-v1-gemma4-runtime-floor');
