...
const VERSION='1.0.127-shared-guide-surface-v236-guide-routing-v1';
...
function install(){
  ...
  load('/app/minilm-response-router-v347.js?v=1.1.0-guide-language-routing',null,()=>Boolean(globalThis.CivweaveResponseRouterV347));
