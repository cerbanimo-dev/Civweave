...
const VERSION='1.0.138-shared-guide-surface-v236-router-stable';
...
function install(){
  ...
  load('/app/family-ai-loader-v105.js?v=1.0.130-shared-ai-lud-boundary',null,()=>Boolean(globalThis.CivweaveFamilyAILoaderV105));
