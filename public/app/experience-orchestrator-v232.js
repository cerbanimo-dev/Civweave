...
const CHAT_MODULES=[
 ...
 ['/app/local-chat-runtime-v295.js?v=1.0.124-v312-runtime-first-bootstrap',()=>Boolean(globalThis.CivweaveLocalChatRuntimeV295?.smoothFitRuntime)],
 ['/app/local-chat-owner-v295.js?v=1.0.115-v302',()=>Boolean(globalThis.CivweaveLocalChatOwnerV295?.intentPrewarm&&globalThis.CivweaveLocalChatOwnerV295?.chatOpenPrewarm)]
];
...
function status(){clearExpired();return Object.freeze({version:VERSION,revision:REVISION,active:activeSlot?{...activeSlot}:null,protectedFlow:protectedFlow(),chatReady:CHAT_MODULES.every(([,ready])=>ready?.()),settingsOwner:'settings-gateway-v317'})}
...
const api=Object.freeze({version:VERSION,revision:REVISION,claim,release,status,protectedFlow,ensureChatModules,settingsInputOwnership:false,settingsOwner:'settings-gateway-v317',settingsLaunchWork:'none'});
globalThis.CivweaveExperienceOrchestratorV232=api;
globalThis.dispatchEvent?.(new CustomEvent('civweave:experience-orchestrator-ready',{detail:{version:VERSION,revision:REVISION,settingsInputOwnership:false,settingsOwner:'settings-gateway-v317'}}));
})();
