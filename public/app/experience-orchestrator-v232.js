...
function status(){clearExpired();return Object.freeze({version:VERSION,revision:REVISION,active:activeSlot?{...activeSlot}:null,protectedFlow:protectedFlow(),settingsReady:Boolean(globalThis.CivweaveSettingsParityV295),chatReady:Boolean(globalThis.CivweaveLocalChatOwnerV295?.intentPrewarm&&globalThis.CivweaveLocalChatRuntimeV295?.smoothFitRuntime),launchReady:Boolean(globalThis.CivweaveLocalChatOwnerV295?.intentPrewarm&&globalThis.CivweaveLocalChatRuntimeV295?.smoothFitRuntime&&globalThis.CivweaveSettingsParityV295)})}
...
globalThis.dispatchEvent?.(new CustomEvent('civweave:experience-orchestrator-ready',{detail:{version:VERSION,revision:REVISION,intentPrewarm:true,smoothFitRuntime:true}}));
})();
