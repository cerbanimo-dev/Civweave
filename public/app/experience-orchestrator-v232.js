...
const CHAT_MODULES=[
 ...
 ['/app/local-chat-owner-v295.js?v=1.0.115-v302',()=>globalThis.CivweaveLocalChatOwnerV295?.version==='1.0.115-local-chat-owner-v302']
];
...
const api=Object.freeze({version:VERSION,revision:REVISION,claim,release,status,protectedFlow,ensureSettingsModule,ensureChatModules,ensureLaunchModules,openSettingsIndependent,launchReadiness:'v299-deterministic-fullscreen-webgpu-fallback'});
