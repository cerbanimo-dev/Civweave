# Fellowfare → Civweave Bridge

Fellowfare v0.3.0 exports `civweave.exchange-bundle` version `1.0.0`.
The bundle is deliberately domain-oriented rather than UI-oriented, so Civweave can ingest the market without importing Fellowfare's screens or local storage implementation.

## Mapping

| Fellowfare | Civweave destination | Meaning |
|---|---|---|
...
## Suggested Civweave import behavior

1. Preserve every Fellowfare ID as an external ID and mint a Civweave canonical ID separately.
