...
function managementReady(){return Boolean(globalThis.CivweaveLocalAISettingsV266?.enhance&&globalThis.CivweaveLocalModelDownloadV266?.status&&globalThis.CivweaveLocalModelRegistryV266?.installable)}
...
globalThis.CivweaveDocumentLifecycleV221=Object.freeze({version:VERSION,revision:REVISION,active:()=>active,ensureLocalAISettingsManagement,scheduleSettingsManagement,managementReady,enhance,settingsEntryOwner:'settings-gateway-v317',inputOwnership:false,managementAfterPaint:true,globalObserverPatch:false,activationRequired:true,launchWork:'none'});
})();
