...
window.CommonweaveWeavelingSteward={VERSION,bus,session,reset,set,setNavigationMode,interpret,answerSkill,prepareSkills,allSkillsAnswered,buildPlan,updateField,updateTask,addTask,removeTask,approve,status,nextRealm,transport,directAnswer};
})();
