(()=>{
'use strict';
const VERSION='1.0.122-server-ai-router-v301-direct-workers-ai';
...
async function handle(request={}){
  ...
  try{
    if(!directWorkers){
      const node=await serverLocal(next,trace);
