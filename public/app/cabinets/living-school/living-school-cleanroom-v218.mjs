...
function renderRecoveryPanel(){
  ...
  <div class="lsc218-note"><b>Flash → Flash-Lite handoff</b><br>Research/design: ${e(design.model||design.provider||'source packet')} · structured pass ${Number(report.structureAttempt||0)} · ${failed} module${failed===1?'':'s'} still need${failed===1?'s':''} attention.${activeCandidate&&failed?' Invalid drafts are quarantined and cannot unlock the final credential.':''}</div>
