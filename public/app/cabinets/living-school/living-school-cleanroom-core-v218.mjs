...
export async function generateSchool(data){
  ...
  }catch(error){setProgress('Shared curriculum generation failed',0);return{...fallback,generation:{...fallback.generation,fallback:true,error:clean(error.message,500)}}}
}
