(()=>{
'use strict';
const VERSION='1.3.0-local-guide-control-bypass-v1-ai-quest-authority';
...
function patch(){
  ...
  try{dispatchEvent(new CustomEvent('civweave:local-guide-control-bypass-ready',{detail:{version:VERSION,controls:['test','greeting','ack','identity'],aiQuestAuthoringRequired:true,deterministicQuestCreation:false}}))}catch{}
  return true
}
...
globalThis.CivweaveLocalGuideControlBypassV1=Object.freeze({version:VERSION,patch,controlKind,aiQuestAuthoringRequired:true,deterministicQuestCreation:false,state:()=>Object.freeze({installed:Boolean(patched)})});
})();