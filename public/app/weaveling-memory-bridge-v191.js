(()=>{
'use strict';
const VERSION='1.0.6-weaveling-memory-bridge-v192-fast';
...
function installFastRuntime(){
  ...
  wrapped.__commonweaveFastMemoryV192=true;
  wrapped.__prior=original;
  runtime.generate=wrapped;
  runtime.fastMemoryRevision=VERSION;
  fastRuntimeInstalled=true;
  return true;
}
