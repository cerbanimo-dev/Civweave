...
const EXTENSION_VERSION='working-campus-additions-v167-antigravity-live-source-proof';
// Previous package compatibility marker: EXTENSION_VERSION='working-campus-additions-v166-two-agent-youtube-reviewed-handoffs'
...
const EXTENSION_CACHE='cwext-working-campus-additions-v167-antigravity-live-source-proof';
// Previous package cache compatibility marker: EXTENSION_CACHE='cwext-working-campus-additions-v166-two-agent-youtube-reviewed-handoffs'
...
const PREVIOUS_EXTENSION_CACHE='cwext-working-campus-additions-v166-two-agent-youtube-reviewed-handoffs';
const INTERMEDIATE_EXTENSION_CACHE='cwext-working-campus-additions-v165-reviewed-requests-material-followthrough-proof-attachments';
